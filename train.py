...
DATA_PATH = "car_price/app/cardekho_data.csv"  # put the csv in project root (same as train.py)
MODEL_PATH = "car_price/app/random_forest_model.pkl"
COLS_PATH = "car_price/app/feature_columns.pkl"
